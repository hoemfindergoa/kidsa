...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="absolute top-full bg-white left-0 w-full bg-white/98 backdrop-blur-xl border-t border-gray-100 shadow-2xl md:hidden animate-in slide-in-from-top-5 duration-300">
