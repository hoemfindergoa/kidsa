...
import Girlonwing from "../public/boywithbrush.png"; // Ensure path is correct for your project structure
...
const Whyheader = () => {
  return (
    ...
    <header className="relative w-full h-auto md:h-[60vh] min-h-[500px] bg-cyan-500 flex items-center justify-center overflow-hidden pt-20 pb-32 md:py-0">
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-center md:text-left">
            ...
            >
                ...
                <span className="text-[#D33060] font-bold text-sm">Why Chose Us</span>
            </motion.div>
