      ...
      <div className="relative z-10 w-full max-w-7xl px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-center md:text-left">
            ...
            >
                ...
                <span className="text-[#D33060] font-bold text-sm">About Us</span>
            </motion.div>
            ...
            <span className="text-[#D33060] inline-block ml-4 relative">
                ...
                <svg className="absolute -top-6 -right-6 w-10 h-10 text-[#F4D03F] animate-bounce" viewBox="0 0 24 24" fill="currentColor">
